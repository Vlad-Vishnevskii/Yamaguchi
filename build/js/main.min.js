...
/* harmony import */ var _modules_table_btn_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/table-btn-handler */ "./js/modules/table-btn-handler.js");
/* harmony import */ var _modules_girl_animation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/girl-animation */ "./js/modules/girl-animation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_table_btn_handler__WEBPACK_IMPORTED_MODULE_4__["tableBtnHandler"])();
  Object(_modules_girl_animation__WEBPACK_IMPORTED_MODULE_5__["girlAnimation"])(); // Modules
  // ---------------------------------
...
/***/ "./js/modules/girl-animation.js":
/*!**************************************!*\
  !*** ./js/modules/girl-animation.js ***!
  \**************************************/
/*! exports provided: girlAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "girlAnimation", function() { return girlAnimation; });
var girlAnimation = function girlAnimation() {
  var container = document.querySelector('.description');
  var hole = document.querySelector('.description__hole-img');
  var girl = document.querySelector('.description__girl-img');

  var showHole = function showHole() {
    hole.classList.add('show-hole');
  };

  var transformHole = function transformHole() {
    hole.classList.add('transform-hole');
  };

  var transformDefaultHole = function transformDefaultHole() {
    hole.classList.remove('transform-hole');
  };

  var girlMoveTop = function girlMoveTop() {
    girl.classList.add('girl-top');
  };

  var girlLevitationDown = function girlLevitationDown() {
    girl.classList.add('girl-levitation-down');
  };

  var girlLevitationTop = function girlLevitationTop() {
    girl.classList.add('girl-levitation-top');
  };

  var girlFinishAnimation = function girlFinishAnimation() {
    girl.classList.add('girl-finish');
  };

  var girlClearLevitationClass = function girlClearLevitationClass() {
...
/***/ "./js/modules/table-btn-handler.js":
/*!*****************************************!*\
  !*** ./js/modules/table-btn-handler.js ***!
  \*****************************************/
/*! exports provided: tableBtnHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tableBtnHandler", function() { return tableBtnHandler; });
var tableBtnHandler = function tableBtnHandler() {
  var btnList = document.querySelector('.about-table__buttons-list');
  var breakpointA = window.matchMedia('(min-width:1366px)');
  var breakpointB = window.matchMedia('(min-width:767px)');

  if (btnList) {
    var imgTop = document.querySelector('.about-table__img-top');
    imgTop.style.top = '60px';
    btnList.addEventListener('click', function (evt) {
      var btnTop = evt.target.closest('.about-table__button--top');
      var btnBottom = evt.target.closest('.about-table__button--bottom');
      var top;
